...
?>
<!-- wp:group {"tagName":"nav","layout":{"type":"constrained","contentSize":"1200px"},"backgroundColor":"base-paper","style":{"spacing":{"padding":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|5","left":"var:preset|spacing|5","right":"var:preset|spacing|5"}},"border":{"bottom":{"color":"var:preset|color|base-rule","width":"1px"}}}} -->
